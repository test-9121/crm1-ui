...
import { Linkedin, Plus, Search, X } from "lucide-react";

interface LinkedInToolbarProps {
  onSearchChange: (term: string) => void;
  onNewProfile: () => void;
}

const LinkedInToolbar = ({
  onSearchChange,
  onNewProfile,
}: LinkedInToolbarProps) => {
  ...
  return (
    <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-center justify-between">
      <div className="flex items-center gap-2">
        ...
        <h2 className="text-xl font-semibold">LinkedIn Profiles</h2>
      </div>
