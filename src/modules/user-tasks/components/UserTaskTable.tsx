...
//             <TableHeader>
//               <TableRow>
//                 {["Task Name", "Assigned To", "Description", "Status", "Priority", "Start Date", "Due Date", "Actions"].map(header => (
...
//                   </TableCell>
//                   <TableCell>
//                     <div className="truncate max-w-[400px]">{task.description}</div>
//                   </TableCell>
//                   <TableCell>
//                     <Badge className={`font-medium rounded-md whitespace-nowrap ${{
//                       "Pending": "bg-amber-100 text-amber-800 hover:bg-amber-200",
//                       "In Progress": "bg-blue-100 text-blue-800 hover:bg-blue-200",
//                       "Completed": "bg-green-100 text-green-800 hover:bg-green-200",
//                       "Canceled": "bg-red-100 text-red-800 hover:bg-red-200"
//                     }[task.status] || "bg-gray-100 text-gray-800 hover:bg-gray-200"}`}>
//                       {task.status}
//                     </Badge>
//                   </TableCell>
//                   <TableCell>
...
//                     }[task.priority] || "bg-gray-100 text-gray-800 hover:bg-gray-200"}`}>
//                       {task.priority}
//                     </Badge>
//                   </TableCell>
